...
public class HuffmanCoderDecoder {
    public static void main(String[] args) {
        ...
        System.out.println("Частота символов в тексте: " + frequencies);
        ...
        System.out.println("Таблица кодов символов: " + codes);
        ...
        System.out.println("Размер исходной строки: " + text.length() * 8 + " бит");
